...
1.  Place the plugin files into a new directory: `/plugins/myauthor/ajaxdispatcher/`.
...
This plugin provides the `parCrypt` helper, available as both a function and a filter, to easily encrypt values for secure parameter handling.
...
1.  **In your markup**, use the `parCrypt` function or filter to encrypt the value.
